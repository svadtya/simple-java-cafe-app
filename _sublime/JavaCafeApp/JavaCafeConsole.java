...
public class JavaCafeConsole {
    ...
    private static void manageItemMenu() {
        ...
        do {
            ...
            switch (menu) {
                case '1': sc.nextLine(); addNewItem(); break;
    ...
    private static char closeReceipt(Receipt receipt) {
        if (receipt.getStatus().equals("PAID")) {
    ...
    /**
     * This methods are used to prompt user to press Enter
